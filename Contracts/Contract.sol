...
contract SafeHeaven is Context, IERC20, Ownable {
    ...
    string private _name = "SafeHeaven";

    string private _symbol = "SFH";
    ...
    address private teamAddr = 0xa0AD5e0E8fc86a8440992Ad57B201FaDefBaF595;

    uint256 lockTime = (block.timestamp).add(3.154e7);
    ...
    uint256 private numTokensSellToAddToLiquidity = 500e9 * 10**18;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        if (block.timestamp < lockTime)
            ...
            require(sender != teamAddr, "Transfer is Locked For Team Address Temporary");
        ...
        emit Transfer(sender, address(0x0), tburn);
